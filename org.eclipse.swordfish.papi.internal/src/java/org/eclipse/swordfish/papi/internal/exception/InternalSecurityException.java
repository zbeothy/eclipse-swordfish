...
/**
 * This exception indicates problems in the security subsystem. It has two subtypes
 * {@link InternalAuthenticationException} and the {@link InternalAuthorizationException} which
 * describe the corresponding subsystem problems in more detail.
 */
public abstract class InternalSecurityException extends InternalSBBException {

    // -------------------------------------------------------------- Constants

    /** (R)evision (C)ontrol (S)ystem (Id)entifier. */
    public static final String RCS_ID = "@(#) $Id: InternalSecurityException.java,v 1.1.2.3 2007/11/09 17:47:15 kkiehne Exp $";

    /** This classes version UID. */
    private static final long serialVersionUID = 3407012631538465447L;
     ...
     */
    protected InternalSecurityException(final String message) {
        super(message);
    }
     ...
     */
    protected InternalSecurityException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     *        exception.
     */
    protected InternalSecurityException(final String message, final Throwable cause, final int errorCode,
     ...
     *        of this throwable has not yet been initialized.
     */
    protected InternalSecurityException(final Throwable cause) {
        super(cause);
    }
}
