...
/**
 * Exception thrown by the business participant indicating that it cannot currently process the
 * message it has received or similar messages (e.g. requests to the same service operation).
 * However, the participant expects to recover within a reasonable amount of time. The SOPERA
 * InternalSBB infrastructure may try to resolve the problem transparently by re-trying the message
 * send within a pre-configured amount of time. In this case, if the re-try is successful, the
 * message sender will not get any notice of the problem. If the problem persists, the message is
 * discarded, and if the sender is to be noticed, it will get a {@link InternalRemoteException}.
 */
public class InternalTemporaryOutOfOrderException extends InternalParticipantException {

    // -------------------------------------------------------------- Constants

    /** (R)evision (C)ontrol (S)ystem (Id)entifier. */
    public static final String RCS_ID =
            "@(#) $Id: InternalTemporaryOutOfOrderException.java,v 1.1.2.3 2007/11/09 17:47:15 kkiehne Exp $";

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 7813845003532458895L;
     ...
     * The Constructor.
     */
    public InternalTemporaryOutOfOrderException() {
        super();
    }
     ...
     */
    public InternalTemporaryOutOfOrderException(final String message) {
        super(message);
    }
     ...
     */
    public InternalTemporaryOutOfOrderException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     *        exception.
     */
    public InternalTemporaryOutOfOrderException(final String message, final Throwable cause, final int errorCode,
     ...
     *        of this throwable has not yet been initialized.
     */
    public InternalTemporaryOutOfOrderException(final Throwable cause) {
        super(cause);
    }
}
