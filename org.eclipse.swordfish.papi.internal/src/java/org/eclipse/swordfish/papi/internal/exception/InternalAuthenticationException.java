...
/**
 * This exception is thrown upon a failed authentication process because of missing/invalid
 * credentials or authentication handlers. If authentication fails because of internal problems of
 * the authentication provider, an {@link InternalInfrastructureException} is thrown instead.
 */
public class InternalAuthenticationException extends InternalSecurityException {

    // -------------------------------------------------------------- Constants

    /** (R)evision (C)ontrol (S)ystem (Id)entifier. */
    public static final String RCS_ID =
            "@(#) $Id: InternalAuthenticationException.java,v 1.1.2.3 2007/11/09 17:47:15 kkiehne Exp $";

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 7012745654889867013L;
     ...
     */
    public InternalAuthenticationException(final String message) {
        super(message);
    }
     ...
     */
    public InternalAuthenticationException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     *        exception.
     */
    public InternalAuthenticationException(final String message, final Throwable cause, final int errorCode,
     ...
     *        of this throwable has not yet been initialized.
     */
    public InternalAuthenticationException(final Throwable cause) {
        super(cause);
    }
}
