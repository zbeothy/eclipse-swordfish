 ...
 * <ul>
 * <li><code>&lt;classname&gt;.&lt;msgID&gt;.severity</code> - internalSeverity of the message</li>
 ...
 * 
 * import org.eclipse.swordfish.papi.extension.operations.AbstractOperationalMessage
 * 
 ...
 * 
 */
public abstract class InternalAbstractOperationalMessage implements InternalOperationalMessage {

    /**
     * key to get from bundle
     */
    private static final String SEVERITY_KEY = "internalSeverity";
    ...
    /**
     * the internalSeverity
     */
    private InternalSeverity internalSeverity;
     ...
     *        id of the message
     */
    protected InternalAbstractOperationalMessage(final int aMsgID) {
     ...
     *        bundle to use
     */
    protected InternalAbstractOperationalMessage(final int aMsgID, final ResourceBundle aBundle) {
        super();
        this.msgID = aMsgID;
     ...
     */
    protected InternalAbstractOperationalMessage(final int aMsgID, final String aBundleName) {
        super();
        this.msgID = aMsgID;
    ...
    /**
     * Gets the internalSeverity.
     * 
     * @return the internalSeverity
     */
    public final InternalSeverity getSeverity() {
    ...
    private void init(final ResourceBundle aBundle) {
        ...
        this.internalSeverity = InternalSeverity.getByName(levelName);
        if (this.internalSeverity == null) throw new IllegalArgumentException("Unknown internalSeverity : " + levelName);
