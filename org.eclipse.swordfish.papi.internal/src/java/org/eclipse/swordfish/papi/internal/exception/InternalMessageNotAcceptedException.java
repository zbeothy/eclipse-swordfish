...
/**
 * The participant rejects a message it receives for a reason which lies in the responsibility of
 * the message sender. Throwing this Exception shall produce a {@InternalMessagingException} at the
 * sender of the rejected message.
 */
public class InternalMessageNotAcceptedException extends InternalParticipantException {

    // -------------------------------------------------------------- Constants

    /** (R)evision (C)ontrol (S)ystem (Id)entifier. */
    public static final String RCS_ID =
            "@(#) $Id: InternalMessageNotAcceptedException.java,v 1.1.2.3 2007/11/09 17:47:15 kkiehne Exp $";

    /** The Constant serialVersionUID. */
    private static final long serialVersionUID = 4912987661289105360L;
     ...
     * The Constructor.
     */
    public InternalMessageNotAcceptedException() {
        super();
    }
     ...
     */
    public InternalMessageNotAcceptedException(final String message) {
        super(message);
    }
     ...
     */
    public InternalMessageNotAcceptedException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     *        exception.
     */
    public InternalMessageNotAcceptedException(final String message, final Throwable cause, final int errorCode,
     ...
     *        of this throwable has not yet been initialized.
     */
    public InternalMessageNotAcceptedException(final Throwable cause) {
        super(cause);
    }
}
