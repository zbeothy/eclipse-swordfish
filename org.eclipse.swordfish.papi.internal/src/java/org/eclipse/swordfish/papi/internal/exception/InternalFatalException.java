...
/**
 * Wrapper for any unexpected Exception or RuntimeException which occurs locally. Thrown
 * <ul>
 * <li>on unexpected Exception from InternalSBB or third-party library</li>
 * <li>on RuntimeException which cannot be handled internally</li>
 * </ul>
 * not thrown
 * <ul>
 * <li>unexpected Exception or RuntimeException at the remote side -&gt; throw
 * {@link InternalRemoteException}</li>
 * <li>on {@link java.lang.Error} -&gt; Errors are either not caught or re-thrown</li>
 * </ul>
 */
public class InternalFatalException extends InternalSBBException {
     ...
     */
    public static final String RCS_ID = "@(#) $Id: InternalFatalException.java,v 1.1.2.3 2007/11/09 17:47:15 kkiehne Exp $";

    /**
     * The Constant serialVersionUID.
     */
    private static final long serialVersionUID = -5934680786043000844L;
     ...
     */
    public InternalFatalException(final String message) {
        super(message);
    }
     ...
     */
    public InternalFatalException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     *        exception.
     */
    public InternalFatalException(final String message, final Throwable cause, final int errorCode,
     ...
     *        of this throwable has not yet been initialized.
     */
    public InternalFatalException(final Throwable cause) {
        super(cause);
    }
