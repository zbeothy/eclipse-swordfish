...
/**
 * Superclass for exceptions thrown by the participant code. InternalSBB needs to catch these
 * exceptions. In other words: All PAPI methods of interfaces which have to be implemented by the
 * participant application throw a InternalParticipantException.
 */
public class InternalParticipantException extends InternalSOPERAException {

    // -------------------------------------------------------------- Constants

    /** (R)evision (C)ontrol (S)ystem (Id)entifier. */
    public static final String RCS_ID = "@(#) $Id: InternalParticipantException.java,v 1.1.2.3 2007/11/09 17:47:15 kkiehne Exp $";
     ...
     * The Constructor.
     */
    public InternalParticipantException() {
        super();
    }
     ...
     */
    public InternalParticipantException(final String message) {
        super(message);
    }
     ...
     */
    public InternalParticipantException(final String message, final Throwable cause) {
        super(message, cause);
    }
     ...
     *        exception.
     */
    public InternalParticipantException(final String message, final Throwable cause, final int errorCode,
     ...
     *        of this throwable has not yet been initialized.
     */
    public InternalParticipantException(final Throwable cause) {
        super(cause);
    }
}
