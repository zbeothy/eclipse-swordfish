...
/**
 * The Class ConsumerInOutJournal.
 * 
 */
public class ConsumerInOutJournal extends ConsumerJournal {

    /**
     * Instantiates a new consumer in out journal.
     * 
     * @param notification
     *        the notification
     */
    public ConsumerInOutJournal(final MessageProcessingNotification notification) {
        super(notification);
    }
     ...
     *        the scaffold
     */
    protected ConsumerInOutJournal(final ConsumerInOutJournal scaffold) {
        super(scaffold);
    }
    ...
    public void replay(final MessagingMonitorBackend backend) {
        if ((null != this.getNotifications()) && (this.getNotifications().size() > 0)) {
            ExchangeJournal tempJournal = new ConsumerInOutJournal(this);
