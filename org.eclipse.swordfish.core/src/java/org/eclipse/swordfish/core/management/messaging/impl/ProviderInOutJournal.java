...
/**
 * The Class ProviderInOutJournal.
 * 
 */
public class ProviderInOutJournal extends ProviderJournal {

    /**
     * Instantiates a new provider in out journal.
     * 
     * @param notification
     *        the notification
     */
    public ProviderInOutJournal(final MessageProcessingNotification notification) {
        super(notification);
    }
     ...
     *        the scaffold
     */
    protected ProviderInOutJournal(final ProviderInOutJournal scaffold) {
        super(scaffold);
    }
    ...
    public void replay(final MessagingMonitorBackend backend) {
        if ((null != this.getNotifications()) && (this.getNotifications().size() > 0)) {
            ExchangeJournal tempJournal = new ProviderInOutJournal(this);
