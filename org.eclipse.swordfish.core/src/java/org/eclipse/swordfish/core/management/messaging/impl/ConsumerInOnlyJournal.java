...
/**
 * The Class ConsumerInOnlyJournal.
 */
public class ConsumerInOnlyJournal extends ConsumerJournal {

    /**
     * Instantiates a new consumer in only journal.
     * 
     * @param notification
     *        the notification
     */
    public ConsumerInOnlyJournal(final MessageProcessingNotification notification) {
        super(notification);
    }
     ...
     *        the scaffold
     */
    protected ConsumerInOnlyJournal(final ConsumerInOnlyJournal scaffold) {
        super(scaffold);
    }
    ...
    public void replay(final MessagingMonitorBackend backend) {
        if ((null != this.getNotifications()) && (this.getNotifications().size() > 0)) {
            ExchangeJournal tempJournal = new ConsumerInOnlyJournal(this);
