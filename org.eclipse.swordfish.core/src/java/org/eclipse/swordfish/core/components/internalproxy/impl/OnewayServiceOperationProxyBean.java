...
/**
 * The Class OnewayServiceOperationProxyBean.
 * 
 */
public class OnewayServiceOperationProxyBean implements ServiceOperationProxy {

    /** Logger used by this class. */
    private static final Log LOG = SBBLogFactory.getLog(OnewayServiceOperationProxyBean.class);

    /** The delivery channel send to be used by this controller. */
    private DeliveryChannelSender deliveryChannelSender;

    /**
     * Instantiates a new oneway service operation proxy bean.
     */
    public OnewayServiceOperationProxyBean() {
        super();
    }
    ...
    public Object invokeServiceOperation(final Collection aMessageExchangeBag, final QName aServiceOperation,
        ...
        while (null != (mex = aController.createInOnlyExchange(aMessageExchangeBag, aServiceOperation))) {
