...
class NSStack {
    ...
    public String getNamespaceURI(final String prefix) {
        final String prefixInter = (prefix == null) ? "" : prefix;
        final String prefixNotNull = prefixInter.intern();
        ...
        for (int cursor = this.top; cursor > 0; cursor--) {
            ...
            if (map.getPrefix() == prefixNotNull) return map.getNamespaceURI();
        }
    ...
    public String getPrefix(final String namespaceURI, boolean noDefault) {
        ...
        final String namespaceURIinter = namespaceURI.intern();
        ...
        for (int cursor = this.top; cursor > 0; cursor--) {
            ...
            if (map.getNamespaceURI() == namespaceURIinter) {
