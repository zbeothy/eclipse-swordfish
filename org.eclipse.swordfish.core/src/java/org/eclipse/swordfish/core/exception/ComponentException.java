 ...
 * 
 */
public abstract class ComponentException extends Abstract_Exception {
     ...
     */
    public ComponentException(final String resourceKey) {
        super(resourceKey);
    }
     ...
     */
    public ComponentException(final String resourceKey, final String parameter1) {
     ...
     *        parameter for gaps in error messages
     */
    public ComponentException(final String resourceKey, final String parameter1, final String parameter2) {
     ...
     *        parameter for gaps in error messages
     */
    public ComponentException(final String resourceKey, final String parameter1, final String parameter2, final String parameter3) {
     ...
     *        the cause of the exception
     */
    public ComponentException(final String resourceKey, final String parameter1, final String parameter2, final Throwable cause) {
     ...
     *        the cause of the exception
     */
    public ComponentException(final String resourceKey, final String parameter1, final Throwable cause) {
     ...
     */
    public ComponentException(final String resourceKey, final String[] messageParameters) {
     ...
     *        the cause of the exception
     */
    public ComponentException(final String resourceKey, final String[] messageParameters, final Throwable cause) {
     ...
     *        the cause of the exception
     */
    public ComponentException(final String resourceKey, final Throwable cause) {
     ...
     *        throwable
     */
    public ComponentException(final Throwable t) {
        super(t);
    }
