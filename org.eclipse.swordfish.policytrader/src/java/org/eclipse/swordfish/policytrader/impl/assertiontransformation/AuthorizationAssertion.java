...
/**
 * The Class AuthorizationAssertion.
 */
public class AuthorizationAssertion extends Writeable implements ClassicAssertion {

    /**
     * Instantiates a new authorization assertion.
     */
    ...
    public QKey getAssertionName() {
        return AssertionTransformer.CLASSIC_AUTHORIZATION;
    }
    ...
    public void writeTo(final XMLStreamWriter writer) throws XMLStreamException {
        writeStartElement(AssertionTransformer.CLASSIC_AUTHORIZATION, writer);
