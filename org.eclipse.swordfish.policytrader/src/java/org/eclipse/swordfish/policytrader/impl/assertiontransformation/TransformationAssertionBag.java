...
/**
 * The Class TransformationAssertionBag.
 */
public class TransformationAssertionBag extends AbstractAssertionBag implements ClassicAssertion {
    ...
    public QKey getAssertionName() {
        return AssertionTransformer.CLASSIC_TRANSFORMATION_BAG;
    }
    ...
    public void writeTo(final XMLStreamWriter writer) throws XMLStreamException {
        writeStartElement(AssertionTransformer.CLASSIC_TRANSFORMATION_BAG, writer);
