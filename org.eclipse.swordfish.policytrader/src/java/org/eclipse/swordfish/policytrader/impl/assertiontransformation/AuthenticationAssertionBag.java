...
/**
 * The Class AuthenticationAssertionBag.
 */
public class AuthenticationAssertionBag extends AbstractAssertionBag implements ClassicAssertion {
    ...
    public QKey getAssertionName() {
        return AssertionTransformer.CLASSIC_AUTHENTICATION_BAG;
    }
    ...
    public void writeTo(final XMLStreamWriter writer) throws XMLStreamException {
        writeStartElement(AssertionTransformer.CLASSIC_AUTHENTICATION_BAG, writer);
