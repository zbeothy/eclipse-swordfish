...
/**
 * Process custom validation assertions
 * 
 ...
 * 
 */
public class CustomValidationProcessor extends AbstractAssertionProcessor {

    /** The Constant CUSTOM_VALIDATION_QNAME. */
    public static final QName CUSTOM_VALIDATION_QNAME = new QName(PolicyConstants.SOP_ASSERTION_URI, "CustomValidation");

    /** The Constant LOCATION_ATTRIBUTE. */
    public static final QName LOCATION_ATTRIBUTE = new QName("location");

    /**
     * Instantiates a new custom validation processor.
     */
    public CustomValidationProcessor() {

    }

    /**
     * Prefer alternatives without additional validation (adds load).
     * 
     * @param alternative
     *        the alternative
     * @param assertion
    ...
    public Object preProcessAlternative(final All alternative) {
        TermIterator sourceIter = new TermIterator(alternative, new PrimitiveAssertionSelector(CUSTOM_VALIDATION_QNAME));
