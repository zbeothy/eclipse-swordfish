...
/**
 * The Class SignatureProcessorTest.
 */
public class SignatureProcessorTest extends AssertionProcessorTest {

    /** The Constant DATA_LOCATION. */
    public static final String DATA_LOCATION = "/data/signature";

    /** The Constant SIGNATURE_QNAME. */
    private final static QName SIGNATURE_QNAME = SignatureProcessor.SIGNATURE_QNAME;

    /** The Constant MESSAGE_ATTRIBUTE. */
    private final static QName MESSAGE_ATTRIBUTE = SignatureProcessor.MESSAGE_ATTRIBUTE;

    /** The Constant VERIFY_ATTRIBUTE. */
    private final static QName VERIFY_ATTRIBUTE = SignatureProcessor.VERIFY_ATTRIBUTE;

    /** The Constant selector. */
    private static final Selector SELECTOR = new PrimitiveAssertionSelector(SIGNATURE_QNAME);

    /**
     * Instantiates a new signature processor test.
     * 
     * @param name
     *        the name
     */
    public SignatureProcessorTest(final String name) {
     ...
     * @throws UnexpectedPolicyProcessingException
     */
    public void testSpecNoYes() throws UnexpectedPolicyProcessingException {
        this.readData("3");
        Policy result = this.getProcessor().match(this.getConsumerPolicy(), this.getProviderPolicy());
        assertTrue(this.isNullPolicy(result));
    }
