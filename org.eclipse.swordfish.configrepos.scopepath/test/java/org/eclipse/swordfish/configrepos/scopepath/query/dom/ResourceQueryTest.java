...
/**
 * The Class ResourceQueryTest.
 */
public class ResourceQueryTest extends TestCase {

    /** The tfactory. */
    private TransformerFactory tfactory = null;

    /**
     * Instantiates a new resource query test.
     * 
     * @param name
     *        the name
     */
    public ResourceQueryTest(final String name) {
        super(name);
    }

    /**
     * Test compile resource query.
     */
    public final void testCompileResourceQuery() {
        try {
            ...
            query.setTree("SBB");
            query.setComponentId("policyresolver");
            query.setResourceId("standard.query");
            this.outputResourceQuery(query);
     ...
     * @throws IOException
     */
    private void outputResourceQuery(final ResourceQuery aQuery) throws ParserConfigurationException, IOException {
        DocumentBuilderFactory factory = DocumentBuilderFactory.newInstance();
        factory.setNamespaceAware(true);
        Document document = factory.newDocumentBuilder().newDocument();
        aQuery.marshal(document);
