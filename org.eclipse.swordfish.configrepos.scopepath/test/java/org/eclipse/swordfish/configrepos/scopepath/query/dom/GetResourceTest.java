...
/**
 * The Class GetResourceTest.
 */
public class GetResourceTest extends TestCase {

    /** The tfactory. */
    private TransformerFactory tfactory = null;

    /**
     * Instantiates a new get resource test.
     * 
     * @param name
     *        the name
     */
    public GetResourceTest(final String name) {
        super(name);
    }

    /**
     * Test compile get resource.
     */
    public final void testCompileGetResource() {
        try {
            ...
            this.outputResourceQuery(request);
     ...
     * @throws IOException
     */
    private void outputResourceQuery(final GetResource aRequest) throws ParserConfigurationException, IOException {
