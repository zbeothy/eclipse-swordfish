...
/**
 * The Class ConfigurationQueryTest.
 */
public class ConfigurationQueryTest extends TestCase {

    /** The tfactory. */
    private TransformerFactory tfactory = null;

    /**
     * Instantiates a new configuration query test.
     * 
     * @param name
     *        the name
     */
    public ConfigurationQueryTest(final String name) {
        super(name);
    }

    /**
     * Test compile configuration query.
     */
    public final void testCompileConfigurationQuery() {
        try {
            ...
            query.setTree("SBB");
            this.outputConfigurationQuery(query);
     ...
     * @throws IOException
     */
    private void outputConfigurationQuery(final ConfigurationQuery aQuery) throws ParserConfigurationException, IOException {
