...
/**
 * The Class ConfigurationQueryImpl.
 */
public class ConfigurationQueryImpl extends org.eclipse.swordfish.configrepos.scopepath.query.dom.impl.ConfigurationQueryTypeImpl
        implements org.eclipse.swordfish.configrepos.scopepath.query.dom.ConfigurationQuery {

    /**
     * Instantiates a new configuration query impl.
     */
    public ConfigurationQueryImpl() {
        super();
    }
     ...
     * (non-Javadoc).
     * 
     * @see org.eclipse.swordfish.configrepos.scopepath.query.dom.ConfigurationQuery#marshal(org.w3c.dom.Document)
     * @param doc
     */
