...
public interface SwordfishContextAware {
	...
	/**
	 * Hook for passing the SwordfishContext.
	 * @param swordfishContext the context for access to Swordfish tool functionality.
	 */
	void setContext(SwordfishContext swordfishContext);
}
